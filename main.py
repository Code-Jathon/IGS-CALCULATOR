...
def main():
    ...
    label= tkinter.Label(ventana, text="FUNLAM", bg="white", fg="#007b99", )
    label.configure(font=("Bahnschrift Light", 16,tkFont.BOLD))
    label.pack()
    style = ttk.Style()    
    ...
    integrales= tkinter.Label(pes0,text="haga algo snakeeeeeeeeee", fg="white")
    integrales.pack()
